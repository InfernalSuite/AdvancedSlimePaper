...
public class v1_14WorldUpgrade implements com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.Upgrade {
    ...
    public void upgrade(v1_9SlimeWorld world) {
        for (com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunk chunk : new ArrayList<>(world.chunks.values())) {
    ...
    private void updateBlockEntities(com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunk chunk, int sectionIndex, int paletteIndex, String oldName, String newName) {
