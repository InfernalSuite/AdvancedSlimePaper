...
public class v1_13WorldUpgrade implements com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.Upgrade {
    ...
    public void upgrade(com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeWorld world) {
        ...
        List<com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunk> chunks = new ArrayList<>(world.chunks.values());
        long lastMessage = -1;

        for (int i = 0; i < chunks.size(); i++) {
            com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunk chunk = chunks.get(i);
            ...
            // Chunk sections
            com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection[] newSections = new com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection[16];
            ...
            for (CompoundTag sectionTag : serializedSections.getValue()) {
                ...
                com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection section = new com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection(null, null, palette, blockStates, null, null, blockLight, skyLight);
    ...
    private ListTag<CompoundTag> serializeSections(com.infernalsuite.asp.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection[] sections) {
