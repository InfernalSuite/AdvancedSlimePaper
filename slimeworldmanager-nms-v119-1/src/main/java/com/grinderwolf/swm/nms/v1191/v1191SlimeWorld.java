...
public class v1191SlimeWorld extends AbstractSlimeNMSWorld {

    private static final InternalPlugin INTERNAL_PLUGIN = new InternalPlugin();

    private CustomWorldServer handle;

    public v1191SlimeWorld(SlimeNMS nms, byte version, SlimeLoader loader, String name,
    ...
    public SlimeLoadedWorld createSlimeWorld(String worldName, SlimeLoader loader, boolean lock) {
        return new v1191SlimeWorld(nms, version, loader == null ? this.loader : loader, worldName, new Long2ObjectOpenHashMap<>(chunks), extraData.clone(),
