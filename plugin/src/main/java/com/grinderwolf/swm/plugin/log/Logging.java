...
public class Logging {
    ...
    public static final String COMMAND_PREFIX = ChatColor.BLUE + ChatColor.BOLD.toString() + "GC " + ChatColor.GRAY + ">> ";
    private static final String CONSOLE_PREFIX = ChatColor.BLUE + "[GC] ";
